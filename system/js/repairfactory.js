$(function () {
    ...
    if(cid!=null || typeof (cid)!="undefined"){
        $.ajax({
            type:"GET",
            dataType:"json",
            url:httpUrl+"/adminRepair/get/"+cid+"",
            success:function (res) {
                ...
                $("#repariname").val(res.data.repairName),
                ...
                var opts = {
                      width : 300,     // 信息窗口宽度
                      height: 100,     // 信息窗口高度
                      title : "维修企业名称："+res.data.repairName , // 信息窗口标题
    ...
    function addOrUpdate(id) {
        ...
        if(typeof (id)!="undefined"){
            url=httpUrl+"/adminRepair/update";
            option={
                id:id,
                longitude:$(".lng").val(),
                latitude:$(".lat").val(),
                ...
                city:$("#city").val(),
                repairName:$("#repariname").val(),
                tel:$("#tel").val(),
                carsId:carsid
            }
        }else{
            url=httpUrl+"/adminRepair/add";
            option={
                longitude:$(".lng").val(),
                latitude:$(".lat").val(),
                location:$("#location").val(),
